 ...
 */
@Disabled
@Autonomous(name = "Blue DragArc With Arm", group = "No")
public class AutoBlueDragArcWithArm extends SkyBotAutonomous {
    ...
    public AutoBlueDragArcWithArm() {super(AllianceColor.BLUE);}
    ...
    // TODO We were having some problems with this on Thursday
