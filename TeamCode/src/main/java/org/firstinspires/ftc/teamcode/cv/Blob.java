 ...
 * created by the findBlobs methods, as well as a field indicating the total number of "condition-satisfying"
 * pixels in the blob. Using these statistics, we can obtain important information about the position,
 * size, shape, and orientation of the blob.
 *
 *
 */
...
public class Blob {
    ...
    */
    ...
    /**
     * Find blobs in a source image.
     * @param src The binary source image, as an array of int (contains only 0s and 1s).
     * @param width width of the source image.
     * @param height height of source image.
     * @return ArrayList of blobs found in the source image.
     */
