 ...
 */
@Disabled
@Autonomous(name = "SkyBot Autonomous Blue 2", group = "No")
public class SkyBotAutonomousBlue2 extends SkyBotAutonomous {
    ...
    public SkyBotAutonomousBlue2() {super(AllianceColor.BLUE);}
    ...
    public void runLoggingOpmode() {
        ...
        resetOdometry(X_START2, Y_START, 180);
        ...
        skyStonePosition = determinePosition(SkyStonePosition.LEFT);
        ...
        // Things changed to make it so we go to the opposite side of each stone than where we go for Red
        if (skyStonePosition == SkyStonePosition.LEFT){
            driveDirectionGyro(30, 0, 180, new Predicate() {
                @Override
                public boolean isTrue() {
            ...
            driveDirectionGyro(30, 0, 180, new Predicate() {
                @Override
                public boolean isTrue() {
                    return robotXYTheta[0] <  X_START - 10.5 * 2.54f;
                }
            });
        } else {
            driveDirectionGyro(30, 180, 180, new Predicate() {
                @Override
                public boolean isTrue() {
                    return robotXYTheta[0] <  X_START - 18.5 * 2.54f;
                }
            });
        }
        driveDirectionGyro(30, -90, 180, new Predicate() {
        ...
        // Uncomment later
//        driveDirectionGyro(60, 0, 180, new Predicate() {
//            @Override
//            public boolean isTrue() {
//                //return robotXYTheta[0] >  125 * 2.54f;
//                return bot.backDistSensor.getDistance(DistanceUnit.CM) < 60;
//            }
//        });
       deliverBlock();
