 ...
 */
@Disabled
@Autonomous(name = "SkyBot Autonomous Blue", group = "No")
public class SkyBotAutonomousBlue extends SkyBotAutonomous {
    ...
    public SkyBotAutonomousBlue() {super(AllianceColor.BLUE);}
    ...
    public void runLoggingOpmode() {
        ...
        // Drive away from the blue wall to be in line with the foundation end
    ...
    void intakeBlock(SkyStonePosition skyStonePosition) {
        turnToHeadingGyro(0, 2, 0.3f, 150, RotationDirection.COUNTER_CLOCK);
