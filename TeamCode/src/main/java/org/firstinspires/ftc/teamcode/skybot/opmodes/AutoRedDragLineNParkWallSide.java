...
@Disabled
@Autonomous(name="Red Drag Line N Park Wall", group="Maybe")
// Park in the first parking space
public class AutoRedDragLineNParkWallSide extends SkyBotAutonomous {
    ...
    public AutoRedDragLineNParkWallSide() {super(AllianceColor.RED);}
