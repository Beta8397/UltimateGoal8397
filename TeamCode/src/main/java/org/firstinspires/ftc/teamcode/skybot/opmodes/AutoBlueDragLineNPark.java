...
@Disabled
@Autonomous(name="Blue Drag Line N Park", group="No")
public class AutoBlueDragLineNPark extends SkyBotAutonomous {
    ...
    public AutoBlueDragLineNPark() {super(AllianceColor.BLUE);}
