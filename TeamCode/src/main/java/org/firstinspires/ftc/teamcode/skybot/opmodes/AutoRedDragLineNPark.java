...
@Disabled
@Autonomous(name="Red Drag Line N Park", group="Maybe")
public class AutoRedDragLineNPark extends SkyBotAutonomous {
    ...
    public AutoRedDragLineNPark() {super(AllianceColor.RED);}
    ...
    public void runLoggingOpmode() {
        ...
        dragFoundationLine(AllianceColor.RED);
