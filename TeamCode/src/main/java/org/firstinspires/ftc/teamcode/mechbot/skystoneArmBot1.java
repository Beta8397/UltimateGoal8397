 ...
 */
public class skystoneArmBot1
{

    protected final boolean LOG_ODOMETRY = false;       //Enable or disable logging of odometry
    ...
    private BNO055Enhanced.AxesMap axesMap = BNO055Enhanced.AxesMap.XYZ;        //Axes map for IMU
    private BNO055Enhanced.AxesSign axesSign = BNO055Enhanced.AxesSign.PPP;     //Axes sign for IMU
    ...
    public BNO055EnhancedImpl imu;          //IMU, our custom class that allows setting of axes and sign maps
     ...
     */
    public skystoneArmBot1(MotorType motorType, double wheelCirc, double length, double width){
     ...
     */
    public skystoneArmBot1(MotorType motorType, double wheelCirc, double length, double width, double gearRatio){
        this.motorType = motorType;
        wheelCircumference = wheelCirc;
    ...
    public void init(HardwareMap ahwMap, float initHeadingDegrees, boolean initializeIMU) {
        ...
        one = hardwareMap.dcMotor.get("M1");    //Back left
        two = hardwareMap.dcMotor.get("M2");    //Front left
        three = hardwareMap.dcMotor.get("M3");  //Front right
        four = hardwareMap.dcMotor.get("M4");   //Back right
        ...
        GeneralMatrixF robotWheelTransform = new GeneralMatrixF(4,4,
                new float[] {-1, 1, -width_length_avg,  1
                        , 1, 1, -width_length_avg, -1
                        ,-1, 1, width_length_avg, -1
                        , 1, 1, width_length_avg,  1} );
